(() => {
  ...
  const text = {
    zh: {
      ...
      emissionsLead: "主榜不是所有企业榜。只包含 Scope 1 + selected Scope 2 + Scope 3、年份、单位、边界和页码闭环企业；partial total 和缺失 Scope 的企业不混入主排序。",
      large: "点击放大查看",
    ...
    en: {
      ...
      emissionsLead: "The main ranking is not an all-company ranking. It only includes companies with Scope 1 + selected Scope 2 + Scope 3, year, unit, boundary, and page evidence closed. Partial totals stay out of the main ordering.",
      large: "View Large",
